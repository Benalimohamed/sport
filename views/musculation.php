	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-dark">
			...
			<div class="collapse navbar-collapse text-center" id="navigation">
				...
				<!--	<li class="nav-item">
						<a class="nav-link" href="abonnement.html">Abonnement</a></a>
					</li>
					<li class="nav-item">
...
$coursC1=new CoursC();
$listecours1=$coursC1->rechercherCours_parcategorie('musculation');
$coach1C=new CoachC();
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 heading">
				...
				<h2 class="title classic">musculation</h2>
			</div>
		</div>
